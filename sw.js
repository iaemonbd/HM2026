...
// Created by IA EMON
// v5.0 — Database Google Sheets/Apps Script থেকে Supabase-এ migrate করা
//        হয়েছে; cache version বাম্প করা হলো যাতে ব্যবহারকারীরা নতুন
//        (compressed) assets ও আপডেটেড কোড পান, পুরনো cache থেকে না
// ══════════════════════════════════════════════════════

const CACHE_NAME  = 'hmlabel-v5.0';
